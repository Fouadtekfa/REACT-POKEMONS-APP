...
//pour modèliser un champ dans notre formulaire
type Field={
    //valeur
    value: any,
    //un message deerreur
    error?: string,
    //si la val est valid ou pas
    isValid?: boolean

}

//le formulaire avec la liste des champs disponible
type Form={
    name: Field,
    hp: Field,
    cp: Field,
...
const PokemonForm: FunctionComponent<Props> = ({pokemon}) => {
    ...
    const [form, setForm]=useState<Form>({
        ...
        hp :{value: pokemon.id, isValid:true},
